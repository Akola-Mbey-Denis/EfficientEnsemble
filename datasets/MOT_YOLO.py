...
class MOT17ObjDetectYOLO(Dataset):
    """
    COCO dataset class.
    """
    def __init__(self, model_type, data_dir='home/denis/Downloads/MOT17Det', json_file='train_cocoformat.json',
        ...
        self.label ="labels"
        self.path =os.path.join(self.data_dir,self.label, self.json_file)
