...
class BDDObjectDetectYOLO(Dataset):
    """
    COCO dataset class.
    """
    def __init__(self, model_type, data_dir='/home/denis/Downloads/BDD_COCO', json_file='labels_coco.json',
        ...
        with open(self.path) as anno_file:
    ...
    def __getitem__(self, index):
        ...
        anno_ids = self.coco.getAnnIds(imgIds=image_idx, iscrowd=None)
