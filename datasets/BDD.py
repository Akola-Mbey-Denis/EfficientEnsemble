...
class BDDObjectDetect(Dataset):
    ...
    def _get_ann_file(self):
        return os.path.join(self._root_dir,self._image_set, 'labels_coco.json')

    def _image_path_from_name(self, file_name):
        """
    ...
    def __getitem__(self, idx):
        ...
        img_path =  self._image_path_from_name(image_name)
